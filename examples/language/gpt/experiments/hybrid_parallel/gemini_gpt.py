...
def gpt2_10b(checkpoint=True):
    return GPTLMModel(hidden_size=4096, num_layers=48, num_attention_heads=32, checkpoint=checkpoint)
...
def gpt2_66b(checkpoint=True):
    return GPTLMModel(hidden_size=9216, num_layers=64, num_attention_heads=72, checkpoint=checkpoint)


def gpt2_92b(checkpoint=True):
    return GPTLMModel(hidden_size=10240, num_layers=72, num_attention_heads=80, checkpoint=checkpoint)


def gpt2_175b(checkpoint=True):
    return GPTLMModel(hidden_size=12288, num_layers=96, num_attention_heads=96, checkpoint=checkpoint)
